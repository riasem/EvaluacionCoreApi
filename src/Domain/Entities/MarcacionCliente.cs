...
public class MarcacionCliente
{
    ...
    [Column("marcacionEntrada", Order = 3, TypeName = "datetime")]
    public DateTime MarcacionEntrada { get; set; }

    [Column("marcacionSalida", Order = 4, TypeName = "datetime")]
    ...
    [Column("totalAtraso", Order = 7, TypeName = "datetime")]
    public DateTime TotalAtraso { get; set; }

    [Column("estadoProcesado", Order = 8, TypeName = "bool")]

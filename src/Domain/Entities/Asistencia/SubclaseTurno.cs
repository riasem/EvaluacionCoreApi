...
[Table("AS_SubclaseTurno", Schema = "dbo")]
public class SubclaseTurno
{
    [Key]
    [Column("id", Order = 0, TypeName = "uniqueidentifier")]
    public Guid Id { get; set; } = Guid.NewGuid();

    [Column("codigoSubclase", Order = 1, TypeName = "varchar")]
    [StringLength(10)] public string CodigoSubclaseTurno { get; set; } = string.Empty;

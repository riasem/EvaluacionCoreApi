...
public class CreateTurnoSubTurnoCommandValidator : AbstractValidator<CreateTurnoSubTurnoCommand>
{
    private readonly IConfiguration _config;
    public CreateTurnoSubTurnoCommandValidator(IConfiguration config)
    {
       // _config = config;

...
public class GetControlAsistenciaNovByFilterSpec : Specification<ControlAsistenciaNovedad_V>
{
    public GetControlAsistenciaNovByFilterSpec(string Udn, string Area, string Departamento, string Periodo, string Suscriptor)
    {

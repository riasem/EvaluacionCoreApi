...
public class GetControlAsistenciaCabByFilterSpec : Specification<ControlAsistenciaCab_V>
{
    public GetControlAsistenciaCabByFilterSpec(string Udn, string Area, string Departamento, string Periodo, string Suscriptor)
    {
        ...
        //    Query.Where(p => p.Periodo == Periodo && p.Udn == Udn && p.Area == Area && p.Identificacion == Suscriptor);
        //}
        //else if (Departamento is null)
        //{
        //    Query.Where(p => p.Periodo == Periodo && p.Udn == Udn && p.Area == Area && p.Identificacion == Suscriptor);
        //}
        //else if (Suscriptor is null)
        //{
        //    Query.Where(p => p.Periodo == Periodo && p.Udn == Udn && p.Area == Area && p.SubcentroCosto == Departamento);
        //}
        ...
        //    Query.Where(p => p.Periodo == Periodo && p.Udn == Udn && p.SubcentroCosto == Departamento && p.Identificacion == Suscriptor);
        //}
        //else if (Area is null && Suscriptor is not null)
        //{
        //    Query.Where(p => p.Periodo == Periodo && p.Udn == Udn && p.SubcentroCosto == Departamento && p.Identificacion == Suscriptor);
        //}
        //else

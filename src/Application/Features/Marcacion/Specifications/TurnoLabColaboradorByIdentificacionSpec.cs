...
public class TurnoLabColaboradorByIdentificacionSpec : Specification<TurnoColaborador>
{
    public TurnoLabColaboradorByIdentificacionSpec(string identificacion, DateTime FechaDesde, DateTime FechaHasta)
    {
